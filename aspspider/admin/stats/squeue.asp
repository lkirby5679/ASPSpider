...
%>
<%
	strSQL = "SELECT * FROM " & tblp2s & " ORDER BY fPage"
...
%>
                  <tr>
                    <td align="left" nowrap><%= rstRecords("fPage") %></td>
                    <td align="right"><a href="<%= rstRecords("fPage") %>" target="_blank">link</a></td>
