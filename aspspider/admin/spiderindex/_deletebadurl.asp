...
%>
<%
 	strSQL = "DELETE FROM " & tblpages & " WHERE fPage LIKE '%" & Request("fBadURL") & "%'"
	runCmd (strSQL)

 	strSQL = "DELETE FROM " & tblp2s & " WHERE fPage LIKE '%" & Request("fBadURL") & "%'"
	runCmd (strSQL)
	
	Response.Redirect("../main.asp?flag=9")
%>
